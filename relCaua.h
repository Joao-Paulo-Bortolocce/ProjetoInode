...
//	int tamBloc,k=0;
//	for(i=0;i<tam;i++){
//		if(disco[disco[pai].dir.entradas[i].inode].inode.header.permissao[0]=='d'){ //se for diret�rio eu chamo recursivamente pra fazer com esse diret�rio novo
//			blocosPerdidos(disco,aux,disco[disco[pai].dir.entradas[i].inode].inode.diretos[0]);
//		}
//		//ap�s fazer com o diret�rio eu vou pegar todos as posi��es diretas, ind, dup e triplo do inode de todas as entradas desse diret�rio
...
//				while(k<tamIndDup+tamInd+QTD_BLOCOS && j<tamBloc){//at� o final do indireto na posicao do indireto duplo
